...
SOURCES = main.cpp list.cpp dumps.cpp test.cpp ../lib_file_proc/file.cpp
OBJECTS = $(SOURCES:%.cpp=list_o/%.o) #rename files *.cpp --> file *.o
EXECUTABLE = list
#sourses is a list
